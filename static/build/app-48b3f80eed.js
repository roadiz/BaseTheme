...
/******/ 	var hotCurrentHash = "e7b90f165a57cce81a99"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Log credits
	 */
	Utils.logCredits('BaseTheme', '#fff', [{ name: 'Rezo Zero', website: 'www.rezo-zero.com' }], [{ name: 'roadiz', website: 'www.roadiz.io' }, { name: 'GSAP', website: 'www.greensock.com' }], '#000');
	...
	if (deviceMobile) Utils.addClass($body[0], 'is-mobile');else Utils.addClass($body[0], 'is-desktop');
	...
	}, new ClassFactory(), location.origin, new GraphicLoader(), new Nav());
	router.initEvents();
